...
raw_prediction_result_save_dir = '../participants_session_raw_prediction'
session_index = int(session_name.split("_")[-1])
participant_session_raw_prediction_dir = os.path.join(raw_prediction_result_save_dir, participant_name, session_name)

# the evaluation dir with model should be the previous session
evaluation_result_save_dir = '../participants_session_raw_prediction_evaluation'
...
for evaluate_trail in evaluate_session_data:
    ...
    original_lite_model_detection_info = realtime_simulation_debouncer(
        original_transfer_lite_model_prediction_result[evaluate_trail][0]
    )

    transfer_lite_model_detection_info = realtime_simulation_debouncer(
