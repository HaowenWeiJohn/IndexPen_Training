...
model = make_simple_model_capacity_increase(class_num=10, learning_rate=1e-3, decay=1e-7)
...
_, cm = plot_confusion_matrix(y_true=Y_test_class, y_pred=Y_pred_class, classes=indexpen_classes[0:10],
                              normalize=False)
