...
model = make_complex_model_exclude_ra_rd(class_num=31, learning_rate=1e-3, decay=1e-5,
                           ...
                           ra_kernel_size1=(3, 6), ra_kernel_size2=(3, 3),
                           cv_reg=2e-5,
                           exclude='rd'
                           )
...
# train  the model
history = model.fit([X_mmw_rA_model_train], Y_model_train,
                    validation_data=([X_mmw_rA_model_test], Y_model_test),
                    epochs=2000,
...
Y_model_pred1 = best_model.predict([X_mmw_rA_model_test])
