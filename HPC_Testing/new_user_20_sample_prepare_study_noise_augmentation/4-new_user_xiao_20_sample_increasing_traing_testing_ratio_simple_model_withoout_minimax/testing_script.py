...
for train_size in train_sizes:
    ...
    X_mmw_rD_train, X_mmw_rD_test, Y_train, Y_test = train_test_split(X_mmw_rD, Y, stratify=Y, train_size=train_size,
                                                                      random_state=3,
                                                                      shuffle=True)

    X_mmw_rA_train, X_mmw_rA_test, Y_train, Y_test = train_test_split(X_mmw_rA, Y, stratify=Y, train_size=train_size,
                                                                      random_state=3,
                                                                      shuffle=True)
