...
load_data_dir  = '../../../data/IndexPenData/IndexPenStudyData/NewUser20Samples/John/John_20_new_gesture_sample_transfer_learning_test'
...
for train_size in train_sizes:
    ...
    fresh_model = make_simple_model(decay=2e-4)
    ...
    # X_mmw_rD_train, Y_train = noise_augmentation(X_mmw_rD_train, Y_train, mean=0, std=10, augmentation_factor=10, min_threshold=-1000,
    #                                              max_threshold=1500,
    #                                              time_series=True)
    #
    ...
    history = fresh_model.fit([X_mmw_rD_train, X_mmw_rA_train], Y_train,
                        validation_data=([X_mmw_rD_test, X_mmw_rA_test], Y_test),
                        epochs=2000,
                        batch_size=16, callbacks=[es, mc, csv_logger], verbose=1, shuffle=True)
