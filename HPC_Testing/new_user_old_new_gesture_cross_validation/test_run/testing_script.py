...
load_data_dir = '../../../data/IndexPenData/IndexPenStudyData/NewUser20Samples/John/John_20_old_gesture_sample_transfer_learning_test'
...
with open('John_old_gesture_cv_best_cm_acc_hist_dict', 'wb') as f:
