...
load_data_dir = '../../../data/IndexPenData/IndexPenStudyData/UserStudy1Data/7-17_all_study_data_cr_(0.8,0.8)'
# load all data and Y
...
model = make_complex_model_without_reg(class_num=31, learning_rate=1e-3, decay=5e-6,
                                       rd_kernel_size1=(3, 3), rd_kernel_size2=(3, 3),
                                       ra_kernel_size1=(3, 6), ra_kernel_size2=(3, 4),
                                       )
